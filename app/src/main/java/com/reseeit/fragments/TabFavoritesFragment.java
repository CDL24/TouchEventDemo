...
public class TabFavoritesFragment extends BaseFragment implements FavoriteAdapter.FavoriteListener, RedeemListener, LibPostListner, InteractionSeenListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.frg_tab_favourites, null);
        try {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FavoriteAdapter(getActivity(), TabFavoritesFragment.this, favoriteList);
    ...
    public boolean onEarnPointClick(Favorite favorite) {
        ...
        InteractionFragmentDialog mDialog = new InteractionFragmentDialog(interaction, TabFavoritesFragment.this, favorite.data.coupon_id);
    ...
    public void onCouponDetailClick(Favorite favorite) {
        CouponDetailFragmentDialog mAdDialog = new CouponDetailFragmentDialog(favorite.data, favorite.image_path, TabFavoritesFragment.this);
    ...
    public void onRedeemClick(Coupon coupon) {
        ...
        postRequest = new PostLibResponse(TabFavoritesFragment.this, new StatusModel(), getActivity(), parmas, WebServices.USER_COUPON_REWARD, CODE_REDEEM_COUPON, true);
    }
...
//        }
    ...
    public void onInteractionSeen(Interaction seenInteraction, String couponId) {
        ...
        postRequest = new PostLibResponse(TabFavoritesFragment.this, new InteractionModel(), getActivity(), parmas, WebServices.INTERACTION_WATCH, CODE_INTERACTION_WATCH, false);
    }
